...
## Zielgruppe
- Geschäftsführende, IT-Verantwortliche und Sicherheitsbeauftragte
- Datenschutz-, Compliance- und Risikomanagement-Verantwortliche
- IT-Professionals, die KI-Systeme sicher einführen oder betreiben möchten
- Security- und Governance-Teams, die bestehende Programme um KI-Risiken erweitern möchten
- Beraterinnen und Berater, die Unternehmen bei sicherer KI-Einführung unterstützen
...
- Interesse an KI-Technologien und deren Einsatz im Unternehmen
- Grundkenntnisse in Cloud Computing und modernen IT-Architekturen von Vorteil
- Programmierkenntnisse sind nicht zwingend erforderlich
- Eigene KI-Projekte oder konkrete Use Cases können gerne eingebracht werden

## Vorbereitung für Teilnehmende (optional)

Empfohlen wird:

* Ein aktueller Windows-, macOS- oder Linux-Rechner
* Stabile Internetverbindung
* Zugriff auf einen modernen Browser
* Optional: Zugang zu Microsoft 365, Azure oder einer bestehenden KI-Testumgebung
* Optional: Beispiele für geplante oder bestehende KI-Anwendungsfälle aus dem eigenen Unternehmen

> Hinweis: Der Workshop ist praxisorientiert aufgebaut. Für die Teilnahme ist keine eigene KI-Infrastruktur zwingend notwendig. Konkrete Unternehmensbeispiele helfen jedoch, die Inhalte direkt auf die eigene Organisation zu übertragen.
